...
<div class="flex min-h-svh flex-col items-center justify-center bg-background px-4 py-16">
	<div class="w-full max-w-md text-center">
		...
		<div class="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
			...
			<a
				href="/"
				class="inline-flex items-center gap-2 rounded-lg bg-primary-strong px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-sm transition-colors hover:bg-primary-strong/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
			>
