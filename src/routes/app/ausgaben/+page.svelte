<script lang="ts">
	...
	// Phase-3 MINIMAL columns — the rich Ausgaben columns (Status/Bezahlt-von/
	// Beleg/Erstattung + bulk) land in Phase 4. These read only fields common to
	// every list row so the route renders + the @phase-3 e2e smoke passes.
