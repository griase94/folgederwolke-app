<script lang="ts">
	/**
	 * Dataviz gallery (dev-only) — every one of the nine locked chart forms with
	 * demo data in its key states. Our standing visual tool: open in light + dark
	 * to eyeball the family against the catalog plates. Guarded to non-prod in
	 * +page.ts.
	 */
