	...
	<div class="border-t border-border/50 px-6 py-4">
		...
		<div class="flex flex-col gap-3 sm:flex-row">
			...
			<a
				...
				class="inline-flex items-center justify-center gap-2 rounded-lg bg-primary-strong px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary-strong/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
			>
				<svg
