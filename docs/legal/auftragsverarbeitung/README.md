...
| **Google LLC**  | Google Drive (age-verschlüsselte DB-Backups) + Google Sheets (Alt-Finanztabelle, Datenimport) | Backup-Dumps (verschlüsselt, für Google nicht lesbar); Legacy-Finanzdaten | https://cloud.google.com/terms/data-processing-addendum                               |
